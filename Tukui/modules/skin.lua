...
local function reskin(f)
    ...
    f:HookScript("OnEnter", function(self) self:SetBackdropBorderColor(unpack(TukuiCF["Colors"].hoverbordercolor)) end)
    f:HookScript("OnLeave", function(self) self:SetBackdropBorderColor(unpack(TukuiCF["Colors"].bordercolor)) end)
end
