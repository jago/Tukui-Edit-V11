...
TukuiDB.CreatePanel(p, 139, 139, "CENTER", Minimap, "CENTER", 0, 0)
p:ClearAllPoints()
...
Minimap:SetPoint("TOPRIGHT", UIParent, "TOPRIGHT", TukuiDB.Scale(-16), TukuiDB.Scale(-16))
Minimap:SetSize(TukuiDB.Scale(139), TukuiDB.Scale(139))
...
Minimap:SetScript("OnMouseUp", function(self, btn)
	if btn == "RightButton" then
		if not TukuiCF["Datatext"].track or TukuiCF["Datatext"].track == 0 then
