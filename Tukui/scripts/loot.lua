...
if not TukuiCF["Loot"].lootframe then return end
...
local createSlot = function(id)
	...
	count:SetFont(TukuiDB.Font.font, 12, "OUTLINE")
	...
	name:SetFont(TukuiDB.Font.font, 13, "OUTLINE")
...
title:SetFont(TukuiCF["Fonts"].font, 13, "OUTLINE")
