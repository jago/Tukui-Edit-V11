...
if not TukuiCF["Loot"].lootrollframe then return end
...
local function CreateRollButton(parent, ntex, ptex, htex, rolltype, tiptext, ...)
	...
	txt:SetFont(TukuiCF["Fonts"].font, 12, "OUTLINE")
...
local function CreateRollFrame()
	...
	status:SetStatusBarTexture(TukuiCF["Textures"].empath)
	...
	bind:SetFont(TukuiCF["Fonts"].font, 12, "OUTLINE")
	frame.fsbind = bind

	local loot = frame:CreateFontString(nil, "ARTWORK")
	loot:SetFont(TukuiCF["Fonts"].font, 12, "OUTLINE")
...
label:SetFont(TukuiCF["Fonts"].font, 12, "OUTLINE")
