...
if not TukuiCF["Nameplates"].enable then return end

local tNamePlates = CreateFrame("Frame", nil, UIParent)
tNamePlates:SetScript("OnEvent", function(self, event, ...) self[event](self, ...) end)

local barTexture = TukuiCF["Textures"].blank
local overlayTexture = [=[Interface\Tooltips\Nameplate-Border]=]
local font, fontSize, fontOutline = TukuiCF["Fonts"].font, 10, "OUTLINE"
local glowTexture = TukuiCF["Textures"].glow
