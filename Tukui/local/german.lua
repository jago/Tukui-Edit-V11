if TukuiDB.client == "deDE" then
	...
	tukuilocal.core_release = "|cffC495DDEclípsé release:|r "..TukuiDB.release
	tukuilocal.core_welcome1 = "Willkommen bei |cffC495DDTukui:|r Version " ..TukuiDB.version -- capitalization
